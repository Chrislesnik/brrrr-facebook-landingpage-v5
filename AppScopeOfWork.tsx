...
import sowPdfUrl from "./Scope of Work - Template.pdf";
import sowXlsxUrl from "./Scope of Work - Template.xlsx";
...
export default function AppScopeOfWork() {
  ...
  const startDownload = React.useCallback(() => {
    const target = downloadUrl || sowXlsxUrl;
    try {
  ...
  const onSubmitContact = async () => {
    ...
    try {
      try {
        await fetch("https://n8n.axora.info/webhook/d7824e07-e488-4cf1-83fd-3c95836833d8", {
          method: "POST",
          ...
          >
            <div className="flex flex-col gap-3">
              <div className="text-default-foreground text-3xl leading-9 font-bold">
                Get Your Free Scope of Work Template
              </div>
              <div className="text-default-500 -mt-1">
                Professional SOW template to plan and track your rehab projects with clarity.
              </div>
